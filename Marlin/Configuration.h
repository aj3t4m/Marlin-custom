...
#define STRING_CONFIG_H_AUTHOR "(tommat for abaku Ender-5)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Abaku Ender-5"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  10.00 //21.73
    #define DEFAULT_Ki   0.59 //1.54
    #define DEFAULT_Kd  42.21 //76.55
  #endif
#else
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -46, -23, -0.9 }
